...
wait(2)
require(game.Players.LocalPlayer.PlayerGui.MainUI.Initiator.Main_Game).caption("@Sanren 散人你个人机", true)
wait(2)
require(game.Players.LocalPlayer.PlayerGui.MainUI.Initiator.Main_Game).caption("@DY Film_A-101 还有你, 你就是个机八 (不接受反驳)", true)
wait(3)
