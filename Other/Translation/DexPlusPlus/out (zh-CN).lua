--[[
	...
	Developed by Chillz
	Translated into Simplified Chinese by FOCUSED_LIGHT
...
local function main()
	...
	G2L["17"]["Text"] = [[(时间戳) <font color="rgb(255, 255, 255)">输出</font>]];
...
local function main()
	...
	Explorer.InitRightClick = function()
		...
		context:Register("COPY",{Name = "拷贝", IconMap = Explorer.MiscIcons, Icon = "Copy", DisabledIcon = "Copy_Disabled", Shortcut = "Ctrl+C", OnClick = function()
		...
		context:Register("DELETE_CHILDREN",{Name = "删除子项目", IconMap = Explorer.MiscIcons, Icon = "Delete", DisabledIcon = "Delete_Disabled", Shortcut = "Shift+Del", OnClick = function()
			local sList = selection.List
			for i = 1,#sList do
		...
		context:Register("GROUP",{Name = "分组", IconMap = Explorer.MiscIcons, Icon = "Group", DisabledIcon = "Group_Disabled", Shortcut = "Ctrl+G", OnClick = function()
			local sList = selection.List
		...
		context:Register("UNGROUP",{Name = "取消分组", IconMap = Explorer.MiscIcons, Icon = "Ungroup", DisabledIcon = "Ungroup_Disabled", Shortcut = "Ctrl+U", OnClick = function()
			local newSelection = {}
			local count = 1
			local isa = game.IsA
		...
		context:Register("SELECT_CHILDREN",{Name = "选择子项目", IconMap = Explorer.MiscIcons, Icon = "SelectChildren", DisabledIcon = "SelectChildren_Disabled", OnClick = function()
			local newSelection = {}
			local count = 1
			local sList = selection.List
		...
		context:Register("TELEPORT_TO",{Name = "传送至...", IconMap = Explorer.MiscIcons, Icon = "TeleportTo", OnClick = function()
			local sList = selection.List
		...
		local OldAnimation
		context:Register("PLAY_TWEEN",{Name = "播放Tween动画", IconMap = Explorer.MiscIcons, Icon = "Play", OnClick = function()
			local sList = selection.List
		...
		local OldAnimation
		context:Register("LOAD_ANIMATION",{Name = "加载此动画", IconMap = Explorer.MiscIcons, Icon = "Play", OnClick = function()
			local sList = selection.List
		...
		context:Register("STOP_ANIMATION",{Name = "停止此动画", IconMap = Explorer.MiscIcons, Icon = "Pause", OnClick = function()
			local sList = selection.List
		...
		context:Register("COLLAPSE_ALL",{Name = "收起全部", OnClick = function()
			local sList = selection.List
		...
		context:Register("CLEAR_SEARCH_AND_JUMP_TO",{Name = "清空搜索并跳转到...", OnClick = function()
			local newSelection = {}
			local count = 1
			local sList = selection.List
		...
		context:Register("COPY_PATH",{Name = "复制路径", IconMap = Explorer.LegacyClassIcons, Icon = 50, OnClick = function()
			local sList = selection.List
			if #sList == 1 then
		...
		context:Register("SAVE_INST",{Name = "保存为文件", IconMap = Explorer.MiscIcons, Icon = "Save", OnClick = function()
			local sList = selection.List
			if #sList == 1 then
		...
		context:Register("BLOCK_REMOTE",{Name = "阻止发送", IconMap = Explorer.MiscIcons, Icon = "Delete", DisabledIcon = "Empty", OnClick = function()
			local sList = selection.List
		...
		context:Register("UNBLOCK_REMOTE",{Name = "解除阻止", IconMap = Explorer.MiscIcons, Icon = "Play", DisabledIcon = "Empty", OnClick = function()
			local sList = selection.List
			for i, list in sList do
				local obj = list.Obj
		...
		context:Register("COPY_API_PAGE",{Name = "复制Roblox API页面链接", IconMap = Explorer.MiscIcons, Icon = "Reference", OnClick = function()
			local sList = selection.List
			if #sList == 1 then
				env.setclipboard(
		...
		context:Register("3DVIEW_MODEL",{Name = "3D预览此对象", IconMap = Explorer.LegacyClassIcons, Icon = 54, OnClick = function()
			local sList = selection.List
			local isa = game.IsA
		...
		context:Register("VIEW_OBJECT",{Name = "观察对象 (右键可重置)", IconMap = Explorer.LegacyClassIcons, Icon = 5, OnClick = function()
			local sList = selection.List
			local isa = game.IsA
		...
		context:Register("VIEW_SCRIPT",{Name = "浏览脚本", IconMap = Explorer.MiscIcons, Icon = "ViewScript", DisabledIcon = "Empty", OnClick = function()
			local scr = selection.List[1] and selection.List[1].Obj
			if scr then ScriptViewer.ViewScript(scr) end
		end})
		context:Register("DUMP_FUNCTIONS",{Name = "传储函数", IconMap = Explorer.MiscIcons, Icon = "SelectChildren", DisabledIcon = "Empty", OnClick = function()
			local scr = selection.List[1] and selection.List[1].Obj
			if scr then ScriptViewer.DumpFunctions(scr) end
		end})

		context:Register("FIRE_TOUCHTRANSMITTER",{Name = "发送TouchTransmitter的信号", OnClick = function()
		...
		context:Register("FIRE_CLICKDETECTOR",{Name = "发送ClickDetector的信号", OnClick = function()
			local hrp = plr.Character and plr.Character:FindFirstChild("HumanoidRootPart")
			if not hrp then return end
			for _, v in ipairs(selection.List) do if v.Obj and v.Obj:IsA("ClickDetector") then fireclickdetector(v.Obj) end end
		end})

		context:Register("FIRE_PROXIMITYPROMPT",{Name = "发送ProximityPrompt的信号", OnClick = function()
			local hrp = plr.Character and plr.Character:FindFirstChild("HumanoidRootPart")
			if not hrp then return end
		...
		context:Register("SAVE_SCRIPT",{Name = "保存脚本", IconMap = Explorer.MiscIcons, Icon = "Save", DisabledIcon = "Empty", OnClick = function()
			for _, v in next, selection.List do
				if v.Obj:IsA("LuaSourceContainer") and env.isViableDecompileScript(v.Obj) then
					...
					if not success or not source then source = ("-- DEX - %s 反编译失败 %s"):format(env.executor, v.Obj.ClassName) end
		...
		context:Register("SAVE_BYTECODE",{Name = "保存脚本字节码", IconMap = Explorer.MiscIcons, Icon = "Save", DisabledIcon = "Empty", OnClick = function()
			for _, v in next, selection.List do
				if v.Obj:IsA("LuaSourceContainer") and env.isViableDecompileScript(v.Obj) then
		...
		context:Register("SELECT_CHARACTER",{Name = "选择角色", IconMap = Explorer.LegacyClassIcons, Icon = 9, OnClick = function()
			local newSelection = {}
			local count = 1
			local sList = selection.List
			local isa = game.IsA
		...
		context:Register("VIEW_PLAYER",{Name = "查看玩家", IconMap = Explorer.LegacyClassIcons, Icon = 5, OnClick = function()
			local newSelection = {}
			local count = 1
			local sList = selection.List
			local isa = game.IsA
		...
		context:Register("SELECT_LOCAL_PLAYER",{Name = "选择本地玩家", IconMap = Explorer.LegacyClassIcons, Icon = 9, OnClick = function()
			pcall(function() if nodes[plr] then selection:Set(nodes[plr]) Explorer.ViewNode(nodes[plr]) end end)
		end})

		context:Register("SELECT_ALL_CHARACTERS",{Name = "选择所有角色", IconMap = Explorer.LegacyClassIcons, Icon = 2, OnClick = function()
			local newSelection = {}
			local sList = selection.List
		...
		context:Register("REFRESH_NIL",{Name = "刷新Nil Instances", OnClick = function()
			Explorer.RefreshNilInstances()
		end})

		context:Register("HIDE_NIL",{Name = "隐藏Nil Instances", OnClick = function()
...
local function main()
		...
		currentclickhandler = function()
			if type(codeToSave) == "string" then
				...
				if env.writefile then
					...
					if not s then
						win.Elements.Error.Text = "错误: " .. msg
						task.spawn(error, msg)
						task.wait(1)
					end
				else
					win.Elements.Error.Text = "你的执行器不支持'writefile'"
					task.wait(1)
				end
	...
	Lib.ContextMenu = (function()
		...
		local function createGui(self)
			local contextGui = create({
				...
				{14,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="EntryName",Parent={13},Position=UDim2.new(0,24,0,0),Size=UDim2.new(1,-24,1,0),Text="复制",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
	...
	Lib.ColorPicker = (function() -- TODO: Convert to newer class model
		...
		local function new()
			...
			local guiContents = create({
				...
				{3,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Title",Parent={2},Position=UDim2.new(0,0,0,-5),Size=UDim2.new(1,0,0,26),Text="基本颜色",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				...
				{17,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Title",Parent={4},Position=UDim2.new(0,-40,0,0),Size=UDim2.new(0,34,1,0),Text="蓝色 (B):",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=1,}},
				...
				{38,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Title",Parent={25},Position=UDim2.new(0,-40,0,0),Size=UDim2.new(0,34,1,0),Text="绿色 (G):",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=1,}},
				...
				{52,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Title",Parent={39},Position=UDim2.new(0,-40,0,0),Size=UDim2.new(0,34,1,0),Text="色调 (H):",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=1,}},
				...
				{67,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Title",Parent={54},Position=UDim2.new(0,-40,0,0),Size=UDim2.new(0,34,1,0),Text="红色 (R):",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=1,}},
				...
				{81,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Title",Parent={68},Position=UDim2.new(0,-40,0,0),Size=UDim2.new(0,34,1,0),Text="饱和度 (S):",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=1,}},
				...
				{95,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Title",Parent={82},Position=UDim2.new(0,-40,0,0),Size=UDim2.new(0,34,1,0),Text="明度 (V):",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=1,}},
	...
	Lib.NumberSequenceEditor = (function()
		local function new() -- TODO: Convert to newer class model
			...
			local guiContents = create({
				...
				{15,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Title",Parent={13},Position=UDim2.new(0,-40,0,0),Size=UDim2.new(0,34,1,0),Text="曲线",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=1,}},
			})
			local window = Lib.Window.new()
			window.Resizable = false
			window:Resize(680,265)
			window:SetTitle("NumberSequence 编辑器")
			newMt.Window = window
			newMt.Gui = window.Gui
			for i,v in pairs(guiContents:GetChildren()) do
				v.Parent = window.GuiElems.Content
	...
	Lib.ColorSequenceEditor = (function() -- TODO: Convert to newer class model
		local function new()
			...
			window:SetTitle("ColorSequence 编辑器")
			newMt.Window = window
			newMt.Gui = window.Gui
			for i,v in pairs(guiContents:GetChildren()) do
				v.Parent = window.GuiElems.Content
			...
			colorBox.InputBegan:Connect(function(input)
				if (input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch) then
					...
					if not editor then
						...
						editor.Window:SetTitle("ColorSequence 取色器")
	...
	Lib.DropDown = (function()
		...
		funcs.SetOptions = function(self,opts)
			...
			if self.CanBeEmpty then
				context:Add({Name = "- 选择 -", function() self.Selected = nil self.OnSelect:Fire(nil) self:Update() end})
			end
...
local function main()
	...
	ModelViewer.ViewModel = function(item, updating)
		...
		if not updating then
			...
			window:SetTitle(item.Name.." - 3D预览")
			pathLabel.Gui.Text = "路径: " .. getPath(originalModel)
			window:Show()
	...
	ModelViewer.Init = function()
		...
		-- Registers
		context:Register("STOP",{Name = "停止查看", OnClick = function()
			ModelViewer.StopViewModel()
		end})
		context:Register("EXIT",{Name = "退出", OnClick = function()
			ModelViewer.StopViewModel()
			context:Hide()
			window:Hide()
		end})
		context:Register("COPY_PATH",{Name = "复制路径", OnClick = function()
			if model then
				env.setclipboard(getPath(originalModel))
			end
		end})
		context:Register("REFRESH",{Name = "刷新", OnClick = function()
			if originalModel then
				ModelViewer.ViewModel(originalModel)
			end
		end})
		context:Register("ENABLE_AUTO_REFRESH",{Name = "启用自动刷新", OnClick = function()
			if originalModel then
				ModelViewer.AutoRefresh = true
				ModelViewer.ViewModel(originalModel)
			end
		end})
		context:Register("DISABLE_AUTO_REFRESH",{Name = "禁用自动刷新", OnClick = function()
			if originalModel then
				ModelViewer.AutoRefresh = false
				ModelViewer.ViewModel(originalModel)
			end
		end})
		context:Register("SAVE_INST",{Name = "保存为文件", OnClick = function()
			if model then
				Lib.SaveAsPrompt("Place_"..game.PlaceId.."_"..originalModel.Name.."_"..os.time(), function(filename)
					window:SetTitle(originalModel.Name.." - 3D预览 - 保存中...")	
					...
					if success then
						window:SetTitle(originalModel.Name.." - 3D预览 - 已保存")
						context:Hide()
						task.wait(5)
						if model then
							window:SetTitle(originalModel.Name.." - 3D预览")
						end
					else
						window:SetTitle(originalModel.Name.." - 3D预览 - 错误")
		...
		context:Register("ENABLE_AUTO_ROTATE",{Name = "启用自动旋转", OnClick = function()
			ModelViewer.AutoRotate = true
			
		end})
		context:Register("DISABLE_AUTO_ROTATE",{Name = "禁用自动旋转", OnClick = function()
			ModelViewer.AutoRotate = false
		end})
		context:Register("LOCK_CAM",{Name = "锁定摄像头", OnClick = function()
			ModelViewer.EnableInputCamera = false
		end})
		context:Register("UNLOCK_CAM",{Name = "解锁摄像头", OnClick = function()
			ModelViewer.EnableInputCamera = true
		end})
		
		context:Register("ZOOM_IN",{Name = "放大", OnClick = function()
			distance = math.clamp(distance - (ModelViewer.ZoomMultiplier * 2), 2, math.huge)
		end})
		
		context:Register("ZOOM_OUT",{Name = "缩小", OnClick = function()
			distance = math.clamp(distance + (ModelViewer.ZoomMultiplier * 2), 2, math.huge)
		end})
...
local function main()
	...
	Properties.DisplayAttributeContext = function(prop)
		...
		context:Add({Name = "编辑", OnClick = function()
			Properties.DisplayAddAttributeWindow(prop)
		end})
		context:Add({Name = "删除", OnClick = function()
	...
	Properties.DisplayAddAttributeWindow = function(editAttr)
		...
		if not win then
			...
			saveButton.OnClick:Connect(function()
				...
				if #name > 100 then
					errorLabel.Text = "错误: 名称超过了100个字符"
					return
			...
			if prop then
				...
				if prop.SpecialRow then
					...
					if prop.CategoryName then
						...
						toggleAttributes.Text = (showingAttrs and "[设置: 开]" or "[设置: 关]")
...
local function main()
	...
	SaveInstance.Init = function()
		...
		local decompileTimeout = AddTextbox("反编译超时 (s)", SaveInstanceArgs.DecompileTimeout, 15)
		...
		local decompileIgnore = AddTextbox("反编译忽略", table.concat(SaveInstanceArgs.DecompileIgnore, ","), 50)
		...
		local NilObj = AddCheckbox("保存Nil Instances", SaveInstanceArgs.NilInstances)
		...
		Button.MouseButton1Click:Connect(function()
			...
			window:SetTitle("保存游戏实例 - 保存中...")
			local s, result = pcall(env.saveinstance, game, fileName, SaveInstanceArgs)
			if s then
				window:SetTitle("保存游戏实例 - 已保存")
			else
				window:SetTitle("保存游戏实例 - 错误")
...
local function main()
	...
	ScriptViewer.DumpFunctions = function(scr)
		...
		function functions:dump_function(input, indent)
			functions:add_to_dump(("\n函数传储: %s"):format(functions:get_function_name(input)), indent)
			functions:add_to_dump(("\n函数上调值: %s"):format(functions:get_function_name(input)), indent)
	...
	ScriptViewer.ViewScript = function(scr)
		...
		if not s or not source then
			...
			dumpbtn.TextColor3 = Color3.new(0.5,0.5,0.5)
			source = "-- 无法查看源码.\n"
			source = source .. "-- 脚本路径: "..getPath(scr).."\n"
			if (scr.ClassName == "Script" and (scr.RunContext == Enum.RunContext.Legacy or scr.RunContext == Enum.RunContext.Server)) or not scr:IsA("LocalScript") then
				source = source .. "-- 原因: 该脚本不在客户端上运行. (尝试使用RunContext Server反编译ServerScript或'Script')\n"
			elseif not env.decompile then
				source = source .. "-- 原因: 你的执行器不支持反编译器. (缺少'decompile'函数)\n"
			else
				source = source .. "-- 原因: 未知\n"
			end
			source = source .. "-- 你的执行器: "..executorName.." ("..executorVersion..")"
		else
			PreviousScr = scr
			dumpbtn.TextColor3 = Color3.new(1,1,1)
			...
			source = "-- 脚本路径: "..getPath(scr).."\n"
			source = source .. "-- 反编译花费了 "..tostring(math.floor( (tick() - oldtick) * 100) / 100).."s.\n"
			source = source .. "-- 你的执行器: "..executorName.." ("..executorVersion..")\n\n"
...
Main = (function()
	...
	Main.LoadModule = function(name)
		if Main.Elevated then -- If you don't have filesystem api then ur outta luck tbh
			...
			if EmbeddedModules then -- Offline Modules
				...
				if not control then Main.Error("缺少嵌入式模块: "..name) end
			elseif _G.DebugLoadModel then -- Load Debug Model File
				...
				if s and hashfunc(moduleStr) == hashs[name] then
					...
					if not s then Main.Error("获取 "..name.." 外部模块数据失败") end
			...
			if not module then Main.Error("未找到模块 "..name) end
	...
	Main.LoadSettings = function()
		local s, data = pcall(env.readfile or error, "DexPlusPlus设置.json")
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			{5,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Title",Parent={3},Position=UDim2.new(0,-190,0,15),Size=UDim2.new(0,100,0,50),Text="Dex++ [中]",TextColor3=Color3.new(1,1,1),TextSize=50,TextTransparency=1,}},
			{6,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Desc",Parent={3},Position=UDim2.new(0,-230,0,60),Size=UDim2.new(0,180,0,25),Text="终极调试套件 [简体中文]",TextColor3=Color3.new(1,1,1),TextSize=18,TextTransparency=1,}},
			...
			{11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Creator",Parent={2},Position=UDim2.new(1,-110,1,-20),Size=UDim2.new(0,105,0,20),Text="由Chillz开发, FOCUSED_LIGHT同人汉化",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=1,}},
	...
	Main.SetMainGuiOpen = function(val)
		...
		Main.MainGui.OpenButton.Text = val and "关闭" or "Dex++ [中]"
	...
	Main.CreateMainGui = function()
		...
		Main.CreateApp({Name = "点击选择部件", IconMap = Main.LargeIcons, Icon = 6, OnClick = function(callback)
			if callback then
				local mouse = Main.Mouse
		...
		Main.CreateApp({Name = "记事本 / 脚本查看器", IconMap = Main.LargeIcons, Icon = "Script_Viewer", Window = ScriptViewer.Window})
		
		Main.CreateApp({Name = "控制台", IconMap = Main.LargeIcons, Icon = "Output", Window = Console.Window})
		
		Main.CreateApp({Name = "保存游戏实例", IconMap = Main.LargeIcons, Icon = "Watcher", Window = SaveInstance.Window})
		
		Main.CreateApp({Name = "3D浏览器", IconMap = Explorer.LegacyClassIcons, Icon = 54, Window = ModelViewer.Window})

		--Main.CreateApp({Name = "秘密服务面板 (已移除)", IconMap = Main.LargeIcons, Icon = "Output", Window = SecretServicePanel.Window})
	...
	Main.Init = function()
		...
		if writefile and isfile and not isfile("DexPlusPlus设置.json") then
			writefile("DexPlusPlus设置.json", Main.ExportSettings())
		end
		...
		-- Load Lib
		local intro = Main.CreateIntro("正在初始化库")
		...
		--[[ Loading bypasses
		intro.SetProgress("正在加载Adonis绕过",0.1)
		pcall(Main.LoadAdonisBypass)
		
		intro.SetProgress("正在加载GC绕过",0.2)
		pcall(Main.LoadGCBypass)]]

		-- Fetch version if needed
		intro.SetProgress("正在获取Roblox版本",0.3)
		if Main.Elevated then
		...
		API = Main.FetchAPI(
			function()
				intro.SetProgress("正在获取API, 请稍候.",0.4)
			end,
			function()
				intro.SetProgress("正在获取API, 由于API文件太大, 请等待下载.",0.45)
			end,
			function()
				intro.SetProgress("正在获取API, LOL你不会还在下载吧? 那你的WiFi很废物了 xD",0.475)
			end
		)
		Lib.FastWait()
		intro.SetProgress("正在获取RMD",0.5)
		RMD = Main.FetchRMD()
		Lib.FastWait()
